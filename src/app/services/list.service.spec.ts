...
describe('ListService', () => {
  ...
  it('getList() should return no list items, when user is logged out',
  ...
  it('getList() should return list of all user\'s items',
    inject([ListService], (service: ListService) => {
  ...
  it('getList() should return empty list, when user has no items in list',
    inject([ListService], (service: ListService) => {
  ...
  it('addNewItem() should add correct new item to collection',
    inject([ListService], (service: ListService) => {
      getUserSubject.next(mockUser);
  ...
  it('deleteItem() should delete correct item from collection',
    inject([ListService], (service: ListService) => {
      getUserSubject.next(mockUser);
